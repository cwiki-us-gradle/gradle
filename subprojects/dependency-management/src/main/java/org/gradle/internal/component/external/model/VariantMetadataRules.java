...
public class VariantMetadataRules {
    ...
    public <T extends ModuleComponentArtifactMetadata> ImmutableList<T> applyArtifactsMetadataRules(VariantResolveMetadata variant, ImmutableList<T> declaredArtifacts, ModuleComponentIdentifier componentIdentifier) {
    ...
    public void addArtifactsAction(VariantAction<? super MutableVariantFilesMetadata> action) {
        if (variantFilesRules == null) {
